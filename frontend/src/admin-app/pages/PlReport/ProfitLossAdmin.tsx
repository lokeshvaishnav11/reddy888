      ...
      <div style={{ paddingTop: '20px' }}>
        ...
        <div className='row'>
          <div className='col-md-12'>
            ...
            <div className='profitloss-box row' style={{ marginLeft: '0px', marginRight: '0px', marginBottom: '16px' }}>
              {Object.keys(pnlboxFinal).map((Item: any, key: any) => {
                return (
                  <div key={key} className={pnlboxFinal[Item] >= 0 ? 'bg-green col15' : 'bg-red col15'}>
