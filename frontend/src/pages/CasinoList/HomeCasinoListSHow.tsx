...
const HomeCasinoListSHow = (props: any) => {
...
// }, [gameUrl]);
  ...
  return (
    <div  className="w-100 overflow-auto d-flex bg-white hide-scrollbar"
  style={{
    padding: "10px 8px",
    gap: "8px",
    overflowX: "auto",
      ...
      {MacJson &&
        MacJson
          ...
          .map((Item, key) => {
            ...
            //     </a>
            //   </div>
              <a href="#"  onClick={(e) => onIntcasinoClick(e, Item.gameId)} style={{ textDecoration: "none" }}>
                <div
...
export default React.memo(HomeCasinoListSHow)
