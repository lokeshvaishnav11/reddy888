...
const DepositStatement = () => {
  ...
  const getAccountStmt = (page: number) => {
    const type =
      location.pathname == "/withdrawstatement" ? "withdraw" : "deposit";
              ...
              <div className="container-fluid">
                <div className="row">
                  <div className="col-lg-2 col-6">
                    <div
                      className="form-group from-date"
                      style={{ width: "100%" }}
                    >
                      <label>From</label>
                ...
                <tbody>
                  {depositStatement ? (
                    depositStatement.map((deposit: any) => {
                      const dateData = moment(deposit.createdAt).format(
